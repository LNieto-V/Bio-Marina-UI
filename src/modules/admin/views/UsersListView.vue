...
<template>
  <div class="p-6 md:p-8 space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
      ...
      >
        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">{{ ROL_LABELS[role] }}</p>
    ...
    <div class="flex flex-wrap items-center gap-3">
      ...
      <div class="relative flex-1 min-w-[180px]">
        ...
        <input
          ...
          class="w-full pl-9 pr-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm placeholder:text-slate-400 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
        />
      </div>
